...
extension Defaults.Keys {
  ...
  static let translationEnabled = Key<Bool>("translationEnabled", default: false)
  static let translationModel = Key<String>("translationModel", default: "deepseek-v4-flash")
